...
async def _poll_once(*, app, db_path: str, api_client: QuotaApiClient) -> None:
    try:
...
def start_scheduler(*, app, db_path: str, api_client: QuotaApiClient, interval_s: int) -> AsyncIOScheduler:
    ...
    async def job_wrapper():
        ...
        await _poll_once(app=app, db_path=db_path, api_client=api_client)
