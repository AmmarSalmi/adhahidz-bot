...
- **Enhanced Connection Resilience**: All core API interactions now feature **increased timeouts (30s)** and robust connection management. Administrative tasks like Order Sync now respect granular proxy settings to bypass server-side rate limits and IP blocks.
