...
- **Profile Usage Limits**: Enforces a fair-usage limit of 3 registration profiles per regular user to ensure system stability and performance (Admin users are exempt).
